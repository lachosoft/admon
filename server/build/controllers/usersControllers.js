...
var UsersControllers = /** @class */ (function () {
    ...
    UsersControllers.prototype.list = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query('select idUsr as Id, nick, nombres, appaterno, apmaterno, email from tbusers where deleted=0')];
                    case 1:
                        Users = _a.sent();
                        res.json(Users);
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        Users = _a.sent();
                        if (Users.length > 0) {
                            return [2 /*return*/, res.json(Users[0])];
                        }
    ...
    UsersControllers.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query('insert into tbusers set?', req.body)];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, database_1.default.query('update tbusers set ? where idUsr = ?', [req.body, id])];
                    case 1:
                        _a.sent();
    ...
    UsersControllers.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                id = req.params.id;
                Users = database_1.default.query("delete from tbusers where idUsr = ?", [id]);
